		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<!-- <label>IA1:</label> -->
						<input type="text" name="" id="updateia1Marks" class="form-control" placeholder="IA1">
					</div>
					<div class="form-group">
						<!-- <label>IA2:</label> -->
						<input type="text" name="" id="updateia2Marks" class="form-control" placeholder="IA2">
					</div>
					<div class="form-group">
						<!-- <label>PRACTICAL:</label> -->
						<input type="text" name="" id="updatepracticalMarks" class="form-control" placeholder="Practical / Viva">
					</div>
					<div class="form-group">
						<!-- <label>SEMESTER:</label> -->
						<input type="text" name="" id="updatesemesterMarks" class="form-control" placeholder="Semester">
					</div>
				</div>
